...
;(function($, window, document, undefined) {
  ...
  // The default shot listretrieved by shots()is any type.
  var SHOT_LIST_TYPES = [
    'animated',
    'attachments',
    'debuts',
  ...
  // Many top-level resourcesusers,buckets, etchave subresources that all behave
  ...
  // All initial Jribbble API methodsshots, buckets, project, etcshare common
