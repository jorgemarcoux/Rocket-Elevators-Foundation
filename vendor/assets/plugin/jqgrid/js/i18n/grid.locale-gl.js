...
$.extend($.jgrid,{
	...
	search : {
	    ...
	    Find: "Buscar",
	    Reset: "Limpar",
	    odata: [{ oper:'eq', text:"igual "},{ oper:'ne', text:"diferente a"},{ oper:'lt', text:"menor que"},{ oper:'le', text:"menor ou igual que"},{ oper:'gt', text:"maior que"},{ oper:'ge', text:"maior ou igual a"},{ oper:'bw', text:"empece por"},{ oper:'bn', text:"non empece por"},{ oper:'in', text:"est en"},{ oper:'ni', text:"non est en"},{ oper:'ew', text:"termina por"},{ oper:'en', text:"non termina por"},{ oper:'cn', text:"contn"},{ oper:'nc', text:"non contn"},{ oper:'nu', text:'is null'},{ oper:'nn', text:'is not null'}],
	...
	edit : {
	    ...
	    bCancel: "Cancelar",
		bClose: "Pechar",
		saveData: "Modificronse os datos, quere gardar os cambios?",
		bYes : "Si",
		bNo : "Non",
		bExit : "Cancelar",
	    msg: {
	        required:"Campo obrigatorio",
	        number:"Introduza un nmero",
	        minValue:"O valor debe ser maior ou igual a ",
	        maxValue:"O valor debe ser menor ou igual a ",
	        email: "non  un enderezo de correo vlido",
	        integer: "Introduza un valor enteiro",
			date: "Introduza unha data correcta ",
			url: "non  unha URL vlida. Prefixo requerido ('http://' ou 'https://')",
			nodefined : " non est definido.",
			novalue : " o valor de retorno  obrigatorio.",
			customarray : "A funcin persoalizada debe devolver un array.",
			customfcheck : "A funcin persoalizada debe estar presente no caso de ter validacin persoalizada."
		}
	},
	view : {
	...
	formatter : {
		...
		date : {
			dayNames:   [
				...
				"Domingo", "Luns", "Martes", "Mrcoles", "Xoves", "Vernes", "Sbado"
			],
			monthNames: [
