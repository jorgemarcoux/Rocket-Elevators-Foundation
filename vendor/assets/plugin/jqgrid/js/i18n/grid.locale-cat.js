...
$.extend($.jgrid,{
	...
	edit : {
		...
		msg: {
		    ...
		    email: "no s una direcci de correu vlida",
		    integer: "Introdueixi un valor enter",
			date: "Introdueixi una data correcta ",
			url: "no s una URL vlida. Prefix requerit ('http://' or 'https://')",
...
// setcolumns module
	...
	errors : {
		...
		model : "Les columnes de noms sn diferents de les columnes del model"
	},
	formatter : {
