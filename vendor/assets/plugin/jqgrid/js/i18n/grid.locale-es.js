 ...
 * Traduccion jqGrid en Espaol por Yamil Bracho
...
$.extend($.jgrid,{
	...
	edit : {
	    ...
	    msg: {
	        ...
	        number:"Introduzca un nmero",
	        minValue:"El valor debe ser mayor o igual a ",
	        maxValue:"El valor debe ser menor o igual a ",
	        email: "no es una direccin de correo vlida",
	        integer: "Introduzca un valor entero",
			date: "Introduza una fecha correcta ",
			url: "no es una URL vlida. Prefijo requerido ('http://' or 'https://')",
			nodefined : " no est definido.",
			novalue : " valor de retorno es requerido.",
			customarray : "La funcin personalizada debe devolver un array.",
			customfcheck : "La funcin personalizada debe estar presente en el caso de validacin personalizada."
		}
	},
	view : {
