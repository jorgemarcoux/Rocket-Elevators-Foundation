...
$.extend($.jgrid,{
	...
	edit : {
		...
		bCancel: "Odustani",
		bClose: "Zatvori",
		saveData: "Podatak je izmjenjen! Sauvaj izmjene?",
		bYes : "Da",
		bNo : "Ne",
		bExit : "Odustani",
		msg: {
			...
			minValue:"vrijednost mora biti vea od ili jednaka sa ",
			maxValue:"vrijednost mora biti manja ili jednaka sa",
			email: "nije ispravna email adresa, nije valjda da ne umije ukucati mail!?",
			...
			customfcheck : "Prilagoena funkcija treba da bude prisutana u sluaju prilagoene provjere!"
