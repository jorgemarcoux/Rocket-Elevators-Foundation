...
(function($) {
	$.countdown.regionalOptions['sr-SR'] = {
		labels: ['Godina', 'Meseci', 'Nedelja', 'Dana', 'asova', 'Minuta', 'Sekundi'],
		labels1: ['Godina', 'Mesec', 'Nedelja', 'Dan', 'as', 'Minut', 'Sekunda'],
		labels2: ['Godine', 'Meseca', 'Nedelje', 'Dana', 'asa', 'Minuta', 'Sekunde'],
