...
ActiveRecord::Schema.define(version: 2020_11_03_150020) do
  create_table 'addresses',
    ...
    t.index %w[building_id], name: 'index_addresses_on_building_id'
    t.index %w[customer_id], name: 'index_addresses_on_customer_id'
  end

  create_table 'batteries',
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8',
               force: :cascade do |t|
    t.bigint 'building_id'
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[building_id], name: 'index_batteries_on_building_id'
    t.index %w[employee_id], name: 'index_batteries_on_employee_id'
  end

  create_table 'building_details',
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8',
               force: :cascade do |t|
    t.bigint 'building_id'
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[building_id], name: 'index_building_details_on_building_id'
  end
  ...
  create_table 'buildings',
    ...
    t.bigint 'address_id'
    t.index %w[address_id], name: 'index_buildings_on_address_id'
    t.index %w[admin_contact_id], name: 'index_buildings_on_admin_contact_id'
    t.index %w[building_detail_id],
            name: 'index_buildings_on_building_detail_id'
    t.index %w[customer_id], name: 'index_buildings_on_customer_id'
    t.index %w[technical_contact_id],
  ...
  create_table 'columns',
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[battery_id], name: 'index_columns_on_battery_id'
  end
  ...
  create_table 'customers',
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'address_id'
    t.index %w[address_id], name: 'index_customers_on_address_id'
    t.index %w[user_id], name: 'index_customers_on_user_id'
  end
  ...
  create_table 'elevators',
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[column_id], name: 'index_elevators_on_column_id'
  end
  ...
  create_table 'employees',
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'user_id'
    t.index %w[user_id], name: 'index_employees_on_user_id'
  end
  ...
  create_table 'leads',
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id], name: 'index_leads_on_user_id'
  end
  ...
  create_table 'quotes',
    ...
    t.string 'email'
    t.string 'phone'
    t.index %w[user_id], name: 'index_quotes_on_user_id'
  end
